...
public class Constants {
    ...
    public static final Rect ROI = new Rect(new Point(450,10), new Point(575,160));
    ...
    public static final double CLAW_GRABBER_OPEN_POSITION = GripperState.OPEN.pos;
    public static final double CLAW_GRABBER_CLOSE_POSITION =  GripperState.CLOSE.pos;
    public static final double CLAW_ROTATOR_SCORING_POSITION = WristState.SCORE.pos;
    public static final double CLAW_ROTATOR_COLLECTING_POSITION = WristState.COLLECT.pos;
    public static final double ARM_POWER = 0.75;
    public static final int ARM_ROTATOR_SCORING_POSITION = ArmPos.ARM_SCORING.pos;
    public static final int ARM_ROTATOR_COLLECTING_POSITION = ArmPos.ARM_COLLECTING.pos;
    public static final int ARM_RAISER_SCORING_POSITION = LiftPos.LIFT_UP.pos;
    public static final int ARM_RAISER_COLLECTING_POSITION = LiftPos.LIFT_DOWN.pos;
